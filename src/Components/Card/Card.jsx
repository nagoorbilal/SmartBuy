...
// <Grid container spacing={0} className="BannerGrid">  <Grid item xs={false}  md={12 / totalItems} sm={12 / totalItems} key={item.Name}>
export default function CardComponent(props){
    ...
    const Cards=props.Items.map((val,i) => {
        return (
            <li className="cards_item">
                ...
                <div className="var2">
                    ...
                    <div className="card_image"><img src={val.image} alt="Card-Product-Img"/></div>
                    <div className="card_content ripple">                        
